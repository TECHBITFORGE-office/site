...
# ------------------ USAGE EXAMPLE ------------------
# llmchat = LLMCHAT()
# for model in llmchat.model_aliases:
#     print("\n")
#     print("="*50)
...
#     messages = [
#         {"role": "user", "content": "Explain quantum computing in simple terms. in 10 to 20 words."}
#     ]
#     stream = llmchat.create(message=messages, model=model, max_tokens=10000, stream=True)
#     for token in stream:
